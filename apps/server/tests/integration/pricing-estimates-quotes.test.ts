...
describe("Sprint 1.4.0 pricing, Estimates, and Quotes", { concurrent: false }, () => {
  ...
  it("reproduces canonical pricing and accepts exactly one immutable Quote into one Project", async () => {
    ...
    expect(first.json()).toMatchObject({
      project: { serviceType: "material_delivery", status: "pending_setup" },
    });
